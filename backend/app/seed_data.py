...
SEED_PAID_RESERVATIONS = [
    {
        ...
        "checkout": date(2026, 6, 22),
        "num_huespedes": 2,
        "metodo": MetodoPagoEnum.mercadopago,
        "referencia": "SEED-ANA-201-20260620",
        "solicitudes": "Check-in temprano",
    },
    {
        "user_email": "luis.perez@gmail.com",
        "room_number": "301",
        "checkin": date(2026, 6, 21),
        "checkout": date(2026, 6, 23),
        "num_huespedes": 3,
        "metodo": MetodoPagoEnum.tarjeta,
        "referencia": "SEED-LUIS-301-20260621",
    ...
    },
    {
        ...
        "checkout": date(2026, 6, 24),
        "num_huespedes": 2,
        "metodo": MetodoPagoEnum.transferencia,
        "referencia": "SEED-MARIA-401-20260622",
